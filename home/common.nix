# Home Manager Common Configuration - Shared User Environment
#
# This module contains shared configuration for all users. It is imported by
# per-user configs (coal.nix, violino.nix) to provide a common baseline.
#
...
# Feature 006-multi-user-support: Shared config extracted for multi-user support
#
# Usage:
#   Import this module in per-user configs and merge with user-specific settings:
#   { config, lib, pkgs, ... }:
#   lib.mkMerge [
...

{
  ...
  programs = {
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # Git Configuration (base - users override userName/userEmail)
    # ─────────────────────────────────────────────────────────────────────────
